									...
									<tr>
										...
										<td>
											...
											<?php echo form_open()?>
												...
												<a href="" class="deleteCustomer btn btn-danger btn-sm" name="<?php echo $custlist['customer_id']?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
