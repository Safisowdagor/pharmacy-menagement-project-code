		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    ...
		                    <p  style="text-align: right;"><a href="<?php echo base_url().'Cproduct/exportCSV'; ?>" class="btn btn-success">ExportCSV </a></p>
		                </div>
		            </div>
		            <div class="panel-body">
		                <div class="table-responsive">
							...
							<td><a href="<?php echo base_url().'Cproduct/product_details/'.$row['product_id']; ?>"><?php echo $row['product_model']; ?> </a></td>
							...
							<td>
											...
											<?php echo form_open()?>
												...
												<a href="" class="deleteProduct btn btn-danger btn-xs" name="<?php echo $row['product_id']; ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
